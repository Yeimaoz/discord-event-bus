...
class EventBus:
    ...
    def publish(
        ...
        *,
        ...
        Known Limitations:
        - The rate-limit token wait budget (DEFAULT_RATE_LIMIT_TIMEOUT_SEC = 60s) is not
          currently overridable per publish() call. Callers that need a shorter deadline
          (e.g., latency-sensitive web handlers) must set a lower manifest rate_limit_per_min
          or handle RateLimitExhausted at the call site.
        """
